...
const About = () => {
  const skills = {
    languages: ["Python", "TypeScript", "JavaScript", "Java", "C++", "HTML/CSS", "SQL", "GO", "Ruby", "C", "C#"],
    ...
    tools: ["Git", "VS Code", "Docker", "Firebase", "MongoDB", "Figma", "PyCharm", "Eclipse", ""],
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                  <div className="space-y-4 sm:space-y-6 order-2 md:order-1">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
                      My name is <span className="text-[#2DB19B] font-semibold">Prudhvi.</span> I am an 19-year-old from India, currently studying{' '}
                      <span className="text-[#2DB19B] font-semibold">Computer Engineering</span> at the{' '}
                      <span className="text-[#2DB19B] font-semibold">K L University.</span>
                    </p>
                    <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                  ...
                  <Card className="dark:bg-[#161B22] dark:border-[#30363D] bg-white border 
                    ...
                    <CardContent className="p-4 sm:p-6 text-center space-y-3 sm:space-y-4">
                      ...
                      <p className="text-sm sm:text-base text-muted-foreground">Sometimes hitting my heart out is a lot more fun than coding.</p>
                    </CardContent>
                  </Card>
                  <Card className="dark:bg-[#161B22] dark:border-[#30363D] bg-white border 
                                 hover:border-[#2DB19B] dark:hover:border-[#2DB19B] 
